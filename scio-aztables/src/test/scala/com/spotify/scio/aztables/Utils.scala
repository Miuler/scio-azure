...
import scribe.format.{ Formatter, bold, closeBracket, cyan, fileName, green, groupBySecond, italic, levelColoredPaddedRight, line, mdcMultiLine, messages, multiLine, newLine, openBracket, position, space, string, threadName, time }
